...
<?php
      ...
      if(isset($_POST['purchase'])){
       $pro_id=$_POST['purchase'];
      
      $_SESSION['ad_name']=$pro_id;
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="buying_details.php">Cart - <span class="cart-amunt">$800</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
         ...
         <div class='single-product'>
                 ...
                 <div class='product-f-image'>
                       ...
                       <a href='#' class='add-to-cart-link'><i class='fa fa-shopping-cart'></i> Add to cart</a>
                                        <a href='purchase_product.php' class='view-details-link' ><i class='fa fa-link'></i> See details</a>
                       </div>
                 ...
                 <h2><a href='#'>Product Id : $pid</a></h2>
                                
                                <div class='product-carousel-price'>
                                    <ins>$price</ins> <del>$800.00</del>
                                </div>
                                <form name='form1' action='' method='post'>
                               
                                <button type='submit' name='purchase' value='$ad_name'>Purchase a Product</button>
                              </form>
