...
$name=$_SESSION['name'];
 ...
 if(isset($_POST['submit'])){
    ...
    $sql_t="SELECT * FROM user_order WHERE U_Name='$name' AND Pid='$pt_Id' ";
    $rs=mysqli_query($cn,$sql_t);
    if(mysqli_num_rows($rs)>0){
        while($rwt=mysqli_fetch_assoc($rs)){
           $aname=$rwt['A_Name'];
           $pay_st=$rwt['Payment_status'];
        }
    }  
    $_SESSION['pid']=$pt_Id;
    $_SESSION['pay_status']=$pay_st;
    $_SESSION['aname']=$aname;
   
    header("Location:get_voucher.php");   
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="orderred_list.php">Order List</a></li>
    ...
    <?php
     ...
     $sql="SELECT * FROM user_order WHERE U_Name='$name'  AND  Payment_status='No'";
     $result=mysqli_query($cn,$sql);
     $num_rows=1;
     echo" Number of rows:$num_rows</br>";
     if(mysqli_num_rows($result)>0){
     while($row=mysqli_fetch_assoc($result)  ){
          $count_product=$num_rows;
          $ad_name=$row['A_Name'];
          $pid=$row['Pid'];
          $pname=$row['Pname'];
          $ptype=$row['Ptype'];
          $price=$row['Total_amount'];
          $amount_after_offer= $row['Amount_after_offer'];
          $bname=$row['Bname'];
          $quantity=$row['Quantity'];
          $order_date=$row['Order_time'];
          $sql1="SELECT * FROM product WHERE ad_name='$ad_name' AND pid='$pid' ";
          $r=mysqli_query($cn,$sql1);
          if(mysqli_num_rows($r)>0){
              while($rw=mysqli_fetch_assoc($r)){
                  $image=$rw['filname'];
              }
          }
          echo"<label id='password' class='fadeIn third' >Count product : $count_product</label></br>";
          ...
          echo"<label id='password' class='fadeIn third'>Quantity_of_product : $quantity</label></br>";
          echo"<label id='password' class='fadeIn third'>Total Amount : $price</label></br>";
          echo"<label id='password' class='fadeIn third'>Amount after offer : $amount_after_offer</label></br>";
          ...
          <button type='submit' name='submit' value='$pid' >Get Payment Voucher</button>
          </form>";
     }
    
    }
         // echo"product id and Admin name:". $pid.' '. $ad_name;
