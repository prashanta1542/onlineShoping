...
<html lang="en">
  ...
  <body>
    ...
    <?php
     ...
     echo"product id and Admin name and user name:". $product_id.' '.$admin_name.' '.$name.'</br>';
    
     $sql="SELECT * FROM user_order WHERE U_Name='$name' AND Pid='$product_id' AND Payment_status='No'";
     $result=mysqli_query($cn,$sql);
     if(mysqli_num_rows($result)>0){
     while($row=mysqli_fetch_assoc($result)){
          $sql1="SELECT * FROM product WHERE ad_name='$admin_name' AND pid='$product_id' ";
          ...
          <button type='submit' name='submit' >Get Payment Voucher</button>
          </form>";
